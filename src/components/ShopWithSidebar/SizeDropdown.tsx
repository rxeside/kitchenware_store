  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      >
        <label
          htmlFor="sizeM"
          className="cursor-pointer select-none flex items-center rounded-md bg-[#543b27] text-white hover:bg-[#543b27] hover:text-white"
        >
        ...
        <label
          htmlFor="sizeL"
          className="cursor-pointer select-none flex items-center rounded-md hover:bg-[#543b27] hover:text-white"
        >
          <div className="relative">
