        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                г.Москва, р-он Щербинка, ул. Железнодорожная, д.22А
              </li>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className="flex ease-out duration-200 hover:text-[#543b27]"
              >
                <svg
          ...
          {/*<div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className="ease-out duration-200 hover:text-[#543b27]" href="#">
                  My Account
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <a className="ease-out duration-200 hover:text-[#543b27]" href="#">
                  Мы не привязываем Вас к сумме заказа
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-[#543b27]" href="#">
                  Бесплатная доставка до т.к
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-[#543b27]" href="#">
          ...
          {/*<div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-[#543b27] ease-out duration-200 hover:bg-opacity-95"
                  href="#"
                >
                  <svg
                    className="fill-current"
