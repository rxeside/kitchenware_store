                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <button
                      id="search-btn"
                      aria-label="Search"
                      className="flex items-center justify-center absolute right-3 top-1/2 -translate-y-1/2 ease-in duration-200 hover:text-[#543b27]"
                    >
                      <svg
              ...
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-[#543b27] w-4.5 h-4.5 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-[#543b27] text-custom-sm font-medium text-dark flex ${
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                {/*<li className="py-4">
                  <a
                    href="#"
                    className="flex items-center gap-1.5 font-medium text-custom-sm text-dark hover:text-[#543b27]"
                  >
                    <svg
                      className="fill-current"
                      width="16"
